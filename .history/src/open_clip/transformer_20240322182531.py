...
class PatchDropout(nn.Module):
    ...
    def __init__(self, prob, grid_size, normal_maksing=False, exclude_first_token=True):
        super().__init__()
        assert 0 <= prob < 1.
        self.prob = prob
        self.exclude_first_token = exclude_first_token  # exclude CLS token
        self.pdf_values = self.normal_distribution(grid_size)
        self.normal_maksing = normal_maksing
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.patch_dropout = PatchDropout(patch_dropout, self.grid_size[0],
                                          normal_maksing) if patch_dropout > 0. else nn.Identity()
