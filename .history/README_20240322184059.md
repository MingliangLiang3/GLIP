...
:-------------------------:|:-------------------------:
![Random Masking](./docs/random_mask_image.png)  |  ![Gaussian Masking Sigma=0.1](./docs/images/gaussian_mask_image_sigma_0.1.png) | ![Gaussian Masking Sigma=0.2](./docs/imagesgaussian_mask_image_sigma_0.2.png) |![Gaussian Masking Sigma=0.8](./docs/imagesgaussian_mask_image_sigma_0.8.png) 
